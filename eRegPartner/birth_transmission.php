...
<head>
    ...
    <title>Birth Records - Partner Transmission System</title>
...
<body>
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="controls-section">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-2">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="mb-0" style="font-size: 1.2rem;">Birth Records - Unregistered</h5>
                </div>
    ...
    async function loadRecords() {
        ...
        try {
            const response = await fetch(`registry_api.php?action=list_records&type=birth&page=${currentPage}&per_page=50&search=${encodeURIComponent(search)}`, {
                headers: {
            ...
            tbody.innerHTML = `<tr><td colspan="10" class="text-center text-danger">Error: ${escapeHtml(error.message)}</td></tr>`;
        }
    }
    ...
    async function loadStats() {
        try {
            const response = await fetch('registry_api.php?action=get_stats&type=birth', {
                headers: {
                    'X-CSRF-Token': CSRF_TOKEN
                }
            });
