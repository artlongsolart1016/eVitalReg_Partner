<?php
/**
 * Birth Viewer - Compact for 15" Monitors
...
if (empty($registryNum)) {
    header('Location: birth_transmission.php');
    exit;
}
...
<head>
    ...
    <title>Birth Record - <?php echo htmlspecialchars($registryNum); ?></title>
...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-left">
            <h4><i class="fas fa-baby me-2"></i>BIRTH RECORD</h4>
        ...
        <div class="navbar-right">
            ...
            <button type="button" class="btn-nav btn-AUSF-nav" onclick="submitPrintASUF()">
                <i class="fas fa-print me-1"></i>Print AUSF
            </button>
                ...
                <div class="info-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="info-row">
                            ...
                            <div class="info-value" id="place-birth">-</div>
                        </div>
                        <div class="info-row">
    ...
    async function loadRecord() {
        ...
        try {
            const response = await fetch(`registry_api.php?action=get_record&type=birth&registry_num=${encodeURIComponent(REGISTRY_NUM)}`, {
                headers: {
    ...
    function displayRecord(data) {
        ...
        document.getElementById('place-birth').textContent = data.PlaceBirth || '-';
